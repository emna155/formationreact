          ...
          >
            ...
            <ul className="flex flex-col lg:flex-row list-none lg:ml-auto">
              ...
              <li className="flex items-center">
                <a
                  className="lg:text-white lg:hover:text-blueGray-200 text-blueGray-700 px-3 py-4 lg:py-2 flex items-center text-xs uppercase font-bold"
                  href="https://www.facebook.com/manahelhajri"
                  target="_blank"
                >
              ...
              <li className="flex items-center">
                <a
                  className="lg:text-white lg:hover:text-blueGray-200 text-blueGray-700 px-3 py-4 lg:py-2 flex items-center text-xs uppercase font-bold"
                  href="https://www.instagram.com/abeille_noire_du_nord?igsh=MWI0N255eWg3cXozbw=="
                  target="_blank"
                >
              ...
              <li className="flex items-center">
                <a
                  ...
                  target="_blank"
                >
                  <i className="lg:text-blueGray-200 text-blueGray-400 fab fa-tiktok text-lg leading-lg " />
                  <span className="lg:hidden inline-block ml-2">tiktok</span>
                </a>
              </li>
